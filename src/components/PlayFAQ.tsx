...
export function PlayFAQ() {
  ...
  const faqItems = [
    {
      question: t("playFAQ.q1"),
      answer: t("playFAQ.a1"),
    },
    {
      question: t("playFAQ.q2"),
      answer: t("playFAQ.a2"),
    },
    {
      question: t("playFAQ.q3"),
      answer: t("playFAQ.a3"),
    },
    {
      question: t("playFAQ.q4"),
      answer: t("playFAQ.a4"),
    },
    {
      question: t("playFAQ.q5"),
      answer: t("playFAQ.a5"),
    },
    {
      question: t("playFAQ.q6"),
      answer: t("playFAQ.a6"),
    },
    {
      question: t("playFAQ.q7"),
      answer: t("playFAQ.a7"),
    },
    {
      question: t("playFAQ.q8"),
      answer: t("playFAQ.a8"),
    },
  ];

  return (
    <section className="py-10 sm:py-16 lg:py-24 bg-muted/30 overflow-hidden">
