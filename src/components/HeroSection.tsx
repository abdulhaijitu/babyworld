            ...
            >
              ...
              <div className="relative z-10 mt-4">
                <Button
                  ...
                  asChild
                >
                  <Link to="/play-booking">{t("hero.offer.cta")}</Link>
                </Button>
              </div>
            </motion.div>
            ...
            >
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2 text-xs text-muted-foreground">
                  ...
                  <span className="font-medium">{t("hero.upcoming.date")}</span>
                </div>
              </div>
              ...
              <div className="mt-4">
                <Button
                  ...
                  asChild
                >
                  <Link to="/birthday-events">{t("hero.upcoming.cta")}</Link>
                </Button>
              </div>
            </motion.div>
          </div>
